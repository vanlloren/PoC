...
# Manually generates a Schnorr group with fixed parameters (for testing purposes)
# To activate this function, replace at row 30 of general_procedures.py the call to generate_schnorr_group()
# with manually_generate_schnorr_group
def manually_generate_schnorr_group():
    # Manually generating a Schnorr group with p=3072bits, q=256bits, and g as a generator
    print("Manually generating Schnorr group parameters...")
    # Using known safe primes for p and q
    p = 
    q = 101049864297795829373808522159596391530451272852729459831881445897052119185651

    g = 
